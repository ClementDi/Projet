    ...
    QGLWidget(format,parent),nav(),scene_3d(),draw_state(true)
{
    ...
    startTimer(1); //start timer every 25ms
}
...
void myWidgetGL::change_rates_state(float Kdirect_s,float Kdiag_s,float Kdouble_s,float Kw_s,float dt_s,float mu_s,float x_wind_s,float y_wind_s,float z_wind_s) {
    //scene3d.;
    scene_3d.Kdirect = Kdirect_s;
    scene_3d.Kdiag  = Kdiag_s;
    scene_3d.Kdouble  = Kdouble_s;
    scene_3d.Kw  = Kw_s;
    scene_3d.dt  = dt_s;
    scene_3d.mu  = mu_s;
    scene_3d.x_wind  = x_wind_s;
    scene_3d.y_wind  = y_wind_s;
    scene_3d.z_wind  = z_wind_s;
}
void myWidgetGL::restart() {
